...
- [Simple simulation with a sudden change](sudden_changes.html)
...
- [Fully Bayes Normal Means via Stan](stan_normal_means.html)	
...
- [svd on single cell data](svd_single_cell_data.html)
