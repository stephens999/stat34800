...
Before running this you will need to install the packages `ashr` from CRAN and
`ebnm` from github, by running something like the following code chunk.
...
abline(h=mean((theta-x.pn$posterior$mean)^2),col="red")
