...
Also yuk!! I had to experiment with bw to get a nicer plot....
```{r}
...
I now could get a nice density esitmate in the range 0 to 2pi by just truncating and renormalizing to have area 1.
